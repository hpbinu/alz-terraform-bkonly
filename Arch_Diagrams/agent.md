...
### Python Environment
- **Location**: `C:\Storage-Kyndryl\terraform\Arch_Diagrams\venv`
...
cd "C:\Storage-Kyndryl\terraform\Arch_Diagrams"
python -m venv venv
...
```powershell
cd "C:\Storage-Kyndryl\terraform\Arch_Diagrams\my_azure_diagrams"
.\venv\Scripts\Activate.ps1
$env:PATH += ";C:\Program Files\Graphviz\bin"
